...
import {Check, ChevronsUpDown, LucideStore as StoreIcon, PlusCircle} from "lucide-react";
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button variant={"outline"} size="sm" role={"combobox"} aria-label={"Select a store"}
